  ...
  return (
    <div className="mt-10 grid grid-cols-1 place-content-center gap-6 @container lg:grid-cols-2 lg:gap-8 ">
      <TemplatePreview
        icon={logo}
        title="Account Email"
        preview="https://s3.amazonaws.com/redqteam.com/raahetijarat-furyroad/public/account-confirmation.png"
      />
      <TemplatePreview
        icon={newsletterImg1}
        title="Order Email"
        preview="https://s3.amazonaws.com/redqteam.com/raahetijarat-furyroad/public/order-confirmation.png"
      />
    </div>
  );
}
